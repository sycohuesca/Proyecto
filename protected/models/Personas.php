...
class Personas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tratamiento, empleo, nombre, apellidos, dni, cargos, email, direccion, localidad, provincia, cp, comunidad, movil, cooporativo, toma_posesion, fecha_de_cese, observaciones', 'required'),
			...
			array('fecha_de_cese', 'length', 'max'=>25),
